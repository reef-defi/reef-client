...
export class HttpUtil {
  static REQ_LOADING_EVENT_OPTIONS = {reportProgress: true, observe: 'events'};

  static withInitLoadingRequestValue(httpRequestObservable: Observable<any>, initLoadingValue: any = null): Observable<any> {
    return httpRequestObservable
      .pipe(
        filter(v => {
          return !(v.type === HttpEventType.ResponseHeader
