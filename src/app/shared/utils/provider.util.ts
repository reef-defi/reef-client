...
export class ProviderUtil {
  static getProviderApiKey(providerName: ProviderName): string {
    ...
    if (!apiKey) {
      throw new Error(
        'No provider apiKey defined for providerName=' + providerName
      );
    }
    return apiKey;
  }
  ...
  static getProviderUrl(providerName: ProviderName): string {
    ...
    if (!url) {
      throw new Error(
        'No provider url defined for providerName=' + providerName
      );
    }
    return url;
  }
  ...
  static getProviderChainId(providerName: ProviderName): number {
    ...
    if (!chainId) {
      throw new Error(
        'No provider chainId defined for providerName=' + providerName
      );
    }
    return chainId;
  }
