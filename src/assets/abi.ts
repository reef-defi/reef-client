  ...
  return {
    ...
    reefVaults: {
      ...
      "abi": [
        ...
        {
          "inputs": [],
          "name": "CurveZapInGeneral",
          "outputs": [
            {
              "internalType": "contract ICurveZapInGeneral",
              "name": "",
              "type": "address"
            }
          ],
        ...
        {
          "inputs": [],
          "name": "CurveZapOutGeneral",
          "outputs": [
            {
              "internalType": "contract ICurveZapOutGeneral",
              "name": "",
              "type": "address"
            }
          ],
        ...
        },
        {
          "inputs": [
            ...
            {
              "internalType": "address",
              "name": "curveExchangeAddress",
              "type": "address"
            }
          ],
          "name": "addNewCurveExchange",
          "outputs": [],
          "stateMutability": "nonpayable",
          "type": "function"
        },
        ...
        },
        {
          "inputs": [
            {
              "internalType": "uint256",
              "name": "_maxInvestedFunds",
              "type": "uint256"
            }
          ],
          "name": "setMaxInvestedFunds",
          "outputs": [],
          "stateMutability": "nonpayable",
          "type": "function"
        },
        ...
        },
        {
          "inputs": [
            {
              "internalType": "address",
              "name": "CurveZapOutGeneralAddress",
              "type": "address"
            }
          ],
          "name": "updateCurveZapOut",
          "outputs": [],
          "stateMutability": "nonpayable",
          "type": "function"
        },
