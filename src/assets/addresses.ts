...
export const addresses: { [chainId: number]: ProtocolAddresses } = {
  ...
  [ChainId.MAINNET]: {
    ...
    [TokenSymbol.BNB]: '',
    [TokenSymbol.LIT]: '0xb59490ab09a0f526cc7305822ac65f2ab12f9723',
  },
  ...
  [ChainId.LOCAL_FORK]: {
    ...
    [TokenSymbol.REEF_WETH_POOL]: '0x7937619a9bd1234a303e4fe752b8d4f37d40e20c',
    [TokenSymbol.REEF_USDT_POOL]: '0xea02e0f8f470de1107cb336f827c4192117574bb',
    // [TokenSymbol.REEF_WETH_POOL]: '0x05aEb0ae4e5af3bAC40A2061C4B17fbDdD1a2F37', // TESTR REEF_WETH_POOL pool
    // [TokenSymbol.REEF_USDT_POOL]: '0x84392A8271473FEC9987e77D202E1B9466AD272e', // TESTR REEF_USDT_POOL pool
    // reef token
    [TokenSymbol.REEF]: '0xfe3e6a25e6b192a42a44ecddcd13796471735acf',
